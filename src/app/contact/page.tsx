    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-2xl px-6">
          ...
          {status === "sent" ? (
            <div className="mt-10 rounded-2xl bg-[#FDF9F9] p-8 text-center">
              <h2 className="text-2xl font-semibold text-[#a30b45]">
                Message Sent
              </h2>
              ...
              <button
                ...
                className="mt-6 rounded-full bg-[#a30b45] px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-[#70002D]"
              >
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.message}
                  onChange={handleChange}
                  className="mt-1 w-full resize-none rounded-lg border border-gray-200 px-4 py-3 text-sm outline-none transition focus:border-[#a30b45] focus:ring-2 focus:ring-[#a30b45]/20"
              ...
              <button
                ...
                className="rounded-full bg-[#a30b45] px-8 py-3 text-sm font-semibold text-white transition hover:bg-[#70002D] disabled:opacity-60"
              >
          ...
          <div className="mt-16 grid gap-8 border-t border-gray-100 pt-12 sm:grid-cols-3">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-[#a30b45]">
                Email
              </h3>
