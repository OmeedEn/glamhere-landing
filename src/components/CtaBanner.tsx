...
export default function CtaBanner() {
  return (
    <section className="relative overflow-hidden bg-[#1a1a1a] py-20 text-center text-white">
      <div className="pointer-events-none absolute -top-20 left-1/4 h-72 w-72 rounded-full bg-[#E8195A]/20 blur-[120px]" />
      <div className="pointer-events-none absolute -bottom-10 right-1/4 h-56 w-56 rounded-full bg-[#E8195A]/15 blur-[100px]" />
